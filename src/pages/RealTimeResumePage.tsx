...
const SKILLS_INVENTORY_NODES: SkillsInventoryNode[] = [
  {
    ...
    location: 'Seattle, WA',
    organizations: ['Microsoft', 'Amazon', 'Accenture'],
  },
  {
    id: 'soc-15-1250',
    label: 'Software Developers and Quality Assurance Analysts',
    ...
    apprenticeshipHours: 100,
    location: 'Austin, TX',
    organizations: ['Dell Technologies', 'IBM', 'GitHub'],
  },
  {
    id: 'soc-15-1210',
    label: 'Computer Operations & Network Support',
    ...
    location: 'Remote',
    organizations: ['Cisco', 'HP Enterprise', 'Rackspace'],
  },
  {
    id: 'soc-17-2050',
    label: 'Engineers',
    ...
    organizations: ['Intel', 'NVIDIA', 'Qualcomm'],
  },
  {
    id: 'soc-27-1020',
    label: 'Designers',
    ...
    organizations: ['IDEO', 'Figma', 'Adobe'],
  },
  {
    id: 'trade-project-controls',
    label: 'Project Controls & Program Management',
    shortLabel: 'Project Ctrl',
    proficiency: 68,
    fullTimeHours: 1450,
    partTimeHours: 410,
    contractHours: 760,
    ...
    apprenticeshipHours: 60,
    location: 'Chicago, IL',
    organizations: ['PwC', 'Deloitte', 'AECOM'],
  },
];
